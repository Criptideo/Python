# DESAFIO 9
# Faça um programa que leia um número inteiro qualquer mostre na tela sua tabuada

n = int(input('Digite um número que te mostrarei sua tabuada: '))
